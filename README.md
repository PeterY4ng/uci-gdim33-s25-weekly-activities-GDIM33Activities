...
2.
In this class, with the TA's help, I made a sparkling effect for the coins dropped by defeated monsters in my game. I created the effect using Unity's Shader Graph, so the coin will sparkle periodically while keeping its original rotation animation.
